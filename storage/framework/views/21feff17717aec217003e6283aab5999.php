<section class="charity-activity">
    <div class="charity-activity-map" style="background-image: url(<?php echo e(asset('frontend/assets/images/map/charity_activity_map.png')); ?>)">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-5">
                <div class="charity-activity__left">
                    <div class="charity-activity__img">
                        <img src="<?php echo e(asset('frontend/assets/images/resources/charity_activity_img.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\kurs\Dernek_main\dernek\resources\views/frontend/includes/charity_activity.blade.php ENDPATH**/ ?>