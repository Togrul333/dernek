...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="percent" type="text" class="form-control <?php if($errors->has("percent")): ?> is-invalid <?php endif; ?>"
                                               name="percent"
                                               value="<?php echo e(isset($donation) ? $donation->percent : old('percent')); ?>">
                                        <?php if($errors->has("percent")): ?>
                                            <div class="invalid-feedback"><?php echo e($errors->first("percent")); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="raised" type="text" class="form-control <?php if($errors->has("raised")): ?> is-invalid <?php endif; ?>"
                                               name="raised"
                                               value="<?php echo e(isset($donation) ? $donation->raised : old('raised')); ?>">
                                        <?php if($errors->has("raised")): ?>
                                            <div class="invalid-feedback"><?php echo e($errors->first("raised")); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="goal" type="text" class="form-control <?php if($errors->has("goal")): ?> is-invalid <?php endif; ?>"
                                               name="goal"
                                               value="<?php echo e(isset($donation) ? $donation->goal : old('goal')); ?>">
                                        <?php if($errors->has("goal")): ?>
                                            <div class="invalid-feedback"><?php echo e($errors->first("goal")); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kurs\Dernek_main\dernek\resources\views/backend/donations/form.blade.php ENDPATH**/ ?>