            ...
            <div class="col-xl-8 col-lg-8">
                <div class="upcoming-events">
                    <div class="upcoming-events__sinlge">
                        <div class="upcoming-events__img-box">
                            <div class="upcoming-events__img">
                                <img src="<?php echo e(asset('frontend/assets/images/event/upcoming-event-img-1.jpg')); ?>" alt="">
                            </div>
                    ...
                    <div class="upcoming-events__sinlge">
                        <div class="upcoming-events__img-box">
                            <div class="upcoming-events__img">
                                <img src="<?php echo e(asset('frontend/assets/images/event/upcoming-event-img-2.jpg')); ?>" alt="">
                            </div>
                            <div class="upcoming-events__date-box">
                                <p>23 <br> Dec</p>
                            </div>
...
<?php /**PATH C:\kurs\Dernek_main\dernek\resources\views/frontend/includes/events.blade.php ENDPATH**/ ?>