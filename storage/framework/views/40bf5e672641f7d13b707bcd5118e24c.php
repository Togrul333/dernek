                ...
                <div class="dropdown">
                    <div class="topbar-item" data-offset="10px,0px">
                        <a href="javascript:void(0);" class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" onclick="event.preventDefault(); document.getElementById('lang').submit();">
                            <img src="<?php echo e(app()->getLocale() == 'tr' ? asset('backend/svg/Ottoman_flag.svg.png') :  asset('backend/svg/en.svg')); ?>" class="h-20px w-20px rounded-sm">
                        </a>
                        <form action="<?php echo e(route('backend.lang')); ?>" method="POST" id="lang">
                            <?php echo csrf_field(); ?>
