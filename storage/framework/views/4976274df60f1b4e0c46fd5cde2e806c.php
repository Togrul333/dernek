        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                ...
                <div class="card card-custom example example-compact">
                    <?php echo $__env->make('backend.includes.form.header', ['page' => 'news'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <form action="<?php echo e($edit === false ?  route('backend.news.store') : route('backend.news.update', ['news' => $news->id])); ?>"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="title:<?php echo e($lang->code); ?>" type="text"
                                                           ...
                                                           value="<?php echo e(isset($news) ? $news->translate($lang->code)?->title : old('title:'.$lang->code)); ?>"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="content:<?php echo e($lang->code); ?>" type="text"
                                                           ...
                                                           value="<?php echo e(isset($news) ? $news->translate($lang->code)?->content : old('content:'.$lang->code)); ?>"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="description:<?php echo e($lang->code); ?>" type="text"
                                                           ...
                                                           value="<?php echo e(isset($news) ? $news->translate($lang->code)?->description : old('description:'.$lang->code)); ?>"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="slug:<?php echo e($lang->code); ?>" type="text"
                                                           ...
                                                           value="<?php echo e(isset($news) ? $news->translate($lang->code)?->slug : old('slug:'.$lang->code)); ?>"
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="link" type="date"
                                               ...
                                               name="action_date"
                                               value="<?php echo e(isset($news) ? $news->date : date('Y-m-d')); ?>"
                                               max="<?php echo e(date('Y-m-d')); ?>">
                                        <?php if($errors->has("action_date")): ?>
                                            <div
                                                class="invalid-feedback"><?php echo e($errors->first("action_date")); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="order" type="number" class="form-control <?php if($errors->has("order")): ?> is-invalid <?php endif; ?>" name="order"
                                               value="<?php echo e(isset($news) ? $news->order : old('order')); ?>">
                                         ...
                                         <span class="switch switch-md switch-icon">
                                             <label>
                                                 <input type="checkbox" class="bool" name="show_on_home"
                                                        value="<?php echo e(isset($news) ? $news->show_on_home : old('show_on_home')); ?>"
                                                     <?php echo e((isset($news) ? old('status',$news->show_on_home) : old('show_on_home',1) ) == 1 ? 'checked' : ''); ?>>
                                                 <span></span>
                                             </label>
                                         </span>
                                    </div>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kurs\Dernek_main\dernek\resources\views/backend/news/form.blade.php ENDPATH**/ ?>