<div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
    <div class="popular-causes__sinlge">
        <div class="popular-causes__img">
            <img src="<?php echo e(asset('frontend/assets/images/resources/popular-causes-3-img-1.jpg')); ?>" alt="">
...
<?php /**PATH C:\kurs\Dernek\resources\views/frontend/pages/donations/inc/donation-card.blade.php ENDPATH**/ ?>