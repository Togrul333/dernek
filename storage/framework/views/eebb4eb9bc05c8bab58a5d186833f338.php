...
<script src="<?php echo e(asset('frontend/assets/js/typed-2.0.11.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/vegas.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/jquery.validate.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/bootstrap-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/countdown.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('frontend/assets/js/jarallax.js')); ?>"></script>
...
<script src="<?php echo e(asset('main/custom.js')); ?>"></script>
<?php /**PATH C:\kurs\Dernek\resources\views/frontend/layouts/scripts.blade.php ENDPATH**/ ?>