...
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/jarallax.css')); ?>">

<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/jquery.mCustomScrollbar.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/bootstrap-datepicker.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/vegas.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/nouislider.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/nouislider.pips.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/asting.css')); ?>">
<!-- Template styles -->
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/style.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/responsive.css')); ?>">


<link rel="stylesheet" href="<?php echo e(asset('main/custom.css')); ?>" />

<!-- CSS Toastr -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css" />
<link rel="icon" type="image/x-icon" href="<?php echo e(asset('frontend/assets/images/favicon.svg')); ?>" />
<?php /**PATH C:\kurs\Dernek_main\dernek\resources\views/frontend/layouts/head.blade.php ENDPATH**/ ?>