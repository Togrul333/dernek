        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="image-layer"
                     style="background-image: url(<?php echo e(asset('frontend/assets/images/main-slider/slider-2-1.jpg')); ?>);"></div>
                <div class="container">
            ...
            <div class="swiper-slide">
                <div class="image-layer"
                     style="background-image: url(<?php echo e(asset('frontend/assets/images/main-slider/slider-2-2.jpg')); ?>);"></div>
                <div class="container">
                    <div class="swiper-slide__inner">
                        <div class="row">
                            <div class="col-xl-12">
