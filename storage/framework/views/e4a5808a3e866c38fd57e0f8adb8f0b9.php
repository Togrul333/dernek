            ...
            <div class="col-xl-4 col-lg-4">
                <div class="give-helping__two-boxes">
                    <div class="give-helping__two-boxes__img">
                        <img src="<?php echo e(asset('frontend/assets/images/resources/give-helping-two-boxs-img.jpg')); ?>" alt="">
                        <div class="give-helping__two-boxes__text">
                            <p><a href="">Join Our <br> Volunteers</a></p>
                        </div>
                    </div>
                    <div class="give-helping__two-boxes__img">
                        <img src="<?php echo e(asset('frontend/assets/images/resources/give-helping-two-boxs-img.jpg')); ?>" alt="">
                        <div class="give-helping__two-boxes__text">
                            <p><a href="">Food & Water <br>
                                    Charity</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="give-helping__cause">
                    <div class="give-helping__cause-shape"
                         style="background-image: url(<?php echo e(asset('frontend/assets/images/shapes/give-helping__cause-shape.png')); ?>)"></div>
...
<?php /**PATH C:\kurs\Dernek_main\dernek\resources\views/frontend/includes/give_helping.blade.php ENDPATH**/ ?>