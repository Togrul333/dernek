    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                @can('sliders index')
                    <li class="menu-item{{ url()->current() ==  route('backend.sliders.index') ? ' menu-item-active' : '' }}" aria-haspopup="true">
                ...
                @endcan
                @can('news index')
                    <li class="menu-item{{ url()->current() == route('backend.news.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.news.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                @endcan
                @can('donations index')
                    <li class="menu-item{{ url()->current() == route('backend.donations.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.donations.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                @can('contacts index')
                    <li class="menu-item{{ url()->current() == route('backend.contacts.index') ? ' menu-item-active' : '' }}"
                        ...
                        <a href="{{ route('backend.contacts.index') }}" class="menu-link">
                            ...
                            <span class="menu-text">
                                                <span class="menu-text">
                                                    @lang('backend.titles.contacts')
                                                </span>
                                            </span>
                        </a>
                    </li>
                @endcan
                @can('volunteers index')
                    <li class="menu-item{{ url()->current() == route('backend.volunteers.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.volunteers.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="menu-text">
                                                <span class="menu-text">
                                                    @lang('backend.titles.volunteers')
                                                </span>
                                            </span>
                        </a>
                    </li>
