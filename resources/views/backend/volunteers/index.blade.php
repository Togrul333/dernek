                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">@lang("backend.titles.volunteers")</h3>
                        </div>
                    </div>
                    @include('backend.volunteers.tables.index')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','name','email','phone','actions'], 'route'=>route('backend.volunteers.index')])
@endsection
