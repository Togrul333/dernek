        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                ...
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ $edit === false ?  route('backend.news.store') : route('backend.news.update', ['news' => $news->id]) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="content:{{ $lang->code }}" type="text"
                                                           ...
                                                           value="{{ isset($news) ? $news->translate($lang->code)?->content : old('content:'.$lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="description:{{ $lang->code }}" type="text"
                                                           ...
                                                           value="{{ isset($news) ? $news->translate($lang->code)?->description : old('description:'.$lang->code) }}"
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="link" type="date"
                                               ...
                                               name="action_date"
                                               value="{{ isset($news) ? $news->date : date('Y-m-d') }}"
                                               max="{{ date('Y-m-d') }}">
                                         ...
                                         <span class="switch switch-md switch-icon">
                                             <label>
                                                 <input type="checkbox" class="bool" name="show_on_home"
                                                        value="{{ isset($news) ? $news->show_on_home : old('show_on_home') }}"
                                                     {{ (isset($news) ? old('status',$news->show_on_home) : old('show_on_home',1) ) == 1 ? 'checked' : '' }}>
                                                 <span></span>
                                             </label>
                                         </span>
                                    </div>
