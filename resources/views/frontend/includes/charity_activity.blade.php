<section class="charity-activity">
    <div class="charity-activity-map" style="background-image: url({{asset('frontend/assets/images/map/charity_activity_map.png')}})">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-5">
                <div class="charity-activity__left">
                    <div class="charity-activity__img">
                        <img src="{{asset('frontend/assets/images/resources/charity_activity_img.jpg')}}" alt="">
                    </div>
                </div>
            </div>
