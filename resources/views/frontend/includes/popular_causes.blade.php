    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                <div class="popular-causes__sinlge">
                    <div class="popular-causes__img">
                        <img src="{{asset('frontend/assets/images/resources/popular-causes-two-1.jpg')}}" alt="">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                <div class="popular-causes__sinlge">
                    <div class="popular-causes__img">
                        <img src="{{asset('frontend/assets/images/resources/popular-causes-two-2.jpg')}}" alt="">
                        <div class="popular-causes__category">
                            <p>Education</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                <div class="popular-causes__sinlge">
                    <div class="popular-causes__img">
                        <img src="{{asset('frontend/assets/images/resources/popular-causes-two-3.jpg')}}" alt="">
                        <div class="popular-causes__category">
                            <p>Education</p>
                        </div>
                    </div>
